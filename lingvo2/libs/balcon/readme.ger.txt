Balabolka (Konsolenanwendung), Version 1.65
...
--sub-sil <Sprecher> oder -sl <Sprecher>
   SAPI 4 und Microsoft Speech Platform: nicht verwendet.
...
Das Programm ermöglicht, Links zu externen WAV-Dateien (Audio-Clips) in Text von Dokumenten einzufügen. Ein Audio-Clip-Tag wird so außehen:
