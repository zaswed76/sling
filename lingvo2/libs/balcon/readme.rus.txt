Балаболка (консольное приложение), версия 1.65
Copyright (с) 2013-2020 Илья Морозов
Все права защищены
...
--sub-format <текст>
   Формат субтитров ("srt", "ssa", "ass" или "smi"), которые необходимо преобразовать в речь. Если параметр не задан, формат будет определен по расширению имени входного файла субтитров.
...
--voice1-langid <идентификатор_языка>
   ...
   am, ar, az, ba, bg, be, ca, cs, cu, cv, da, de, el, en, es, eu, fi, fil, fr, ja, he, hi, hr, hu, hy, it, gn, gu, ka, kk-Cyr, kk-Lat, kn, ko, ky, lo, mk, no, pl, pt, ro, ru, sk, sl, sr-Cyr, sr-Lat, sv, tg, th, tr, tt, uk, zh.
...
--voice1-roman
   Использовать основной голос для чтения римских чисел. Если для чтения латинских букв задан дополнительный голос, программа не будет менять голос при чтении римских чисел.
