Balabolka (Command Line Utility), version 1.65
Copyright (c) 2013-2020 Ilya Morozov
All Rights Reserved
...
-d <file_name>
   Uses a dictionary for pronunciation correction (*.BXD, *.DIC or *.REX). The command line may contain more than one option [-d].
...
--sub-format <text>
   Sets the format of input subtitles ("srt", "ssa", "ass" or "smi"). If the option is not specified, the format will be determined through the file extension.
...
--sub-sil <voice_name> or -sl <voice_name>
...
--voice1-langid <language_id>
   ...
   The list of supported language IDs is based on ISO 639-1 codes: am, ar, az, ba, bg, be, ca, cs, cu, cv, da, de, el, en, es, eu, fi, fil, fr, ja, he, hi, hr, hu, hy, it, gn, gu, ka, kk-Cyr, kk-Lat, kn, ko, ky, lo, mk, no, pl, pt, ro, ru, sk, sl, sr-Cyr, sr-Lat, sv, tg, th, tr, tt, uk, zh.
